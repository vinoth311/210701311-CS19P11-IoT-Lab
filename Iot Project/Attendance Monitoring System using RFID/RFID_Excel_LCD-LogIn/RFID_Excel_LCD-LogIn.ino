...
String Name1="1638322736";//first UID card
String Name2="3554014";//second UID card
String Name3="1638322736";//third UID card
String Name4="215112098";//fourth UID card
String Name5="211189181171";//
String Name6="3525118527";//and so on.
...
void loop() {
 ...
 //Serial.println(card_ID);//Uncomment this line to scan the card ID and appear it on Serial monitor.
       ...
       if(card_ID==Name1){
       Name="VINOTH N";//user name
       Number=210701311;//user number
       j=0;//incresd by one for every user you add
       s=0;//++1
      }
      else if(card_ID==Name2){
       Name="VARUNESH B";//user name
       Number=210701303;//user number
       j=1;//++1
       s=1;//++1
      }
      else if(card_ID==Name3){
       Name="THIRUEASWARAN V";//user name
       Number=210701290;//user number
       j=2;//++1
       s=2;//++1
      }
      else if(card_ID==Name4){
       Name="VIMAL KB";//user name
       Number=210701309;//user number
       j=3;//++1
       s=3;//++1
      }
      else if(card_ID==Name5){
       Name="VISHAL D";//user name
       Number=210701313;//user number
       j=4;//++1
       s=4;//++1
      }
      else if(card_ID==Name6){
       Name="PONMANI ";//user name
       Number=210701295;//user number
